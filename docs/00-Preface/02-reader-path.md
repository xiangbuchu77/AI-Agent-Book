...
本书面向已经具备基础编程能力、希望进入 AI 应用开发和 Agent 工程的读者。你不需要先成为算法研究员，但需要理解模型能力、系统边界和工程约束。

学习路线按“理解模型、组织上下文、接入知识、编排行动、设计系统、准备面试”推进。每一部分都服务于最终目标：构建可靠的 AI Agent。
...
- [Next](03-engineering-mindset.md)
